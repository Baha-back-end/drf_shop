...
class PhotoGalleryCategory(models.Model):
    ...
    class Meta:
        verbose_name = _("gallery photo category")
        verbose_name_plural = _("gallery photo categories")
...
class Specialist(models.Model):
    ...
    certificates = RichTextField(_("certificates"))
...
class StoryVideo(models.Model):
    ...
    order = models.IntegerField(_("order"))
    video = models.ForeignKey(Media, on_delete=models.CASCADE, verbose_name=_("video"))

    class Meta:
        verbose_name = _("story video")
        verbose_name_plural = _("story videos")

    def __str__(self):
        return f"ID: {self.id}|Story: {self.story}"
