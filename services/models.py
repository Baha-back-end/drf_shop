...
class WhoPerformsProcedure(models.Model):
    specialist = models.ForeignKey('clinics.Specialist', on_delete=models.CASCADE, verbose_name=_("specialist"),
...
class OrderService(models.Model):
    ...
    service = models.ForeignKey(Service, on_delete=models.CASCADE, verbose_name=_("service"))
    status = models.CharField(_("status"), max_length=100, choices=OrderStatus.choices, default=OrderStatus.NEW)
